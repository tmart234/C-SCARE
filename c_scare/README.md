...
| `client.py` | `DICOMSocket` — stateful SCU client (association + DIMSE) built on `scapy_dicom`; plus the A-ASSOCIATE-RJ recon helpers `classify_reject` / `reject_is_called_aet_unrecognized` |
