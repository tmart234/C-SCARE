...
| **Quantified**        | **5** workflows (W1–W5) | **11** attack categories · **206** payloads · **30** CVEs reproduced (DCMTK, GDCM, Orthanc, pydicom, dcm4che) (+ inspired-by & config-file CVEs) | **6** targets · **2** engines · **3** sanitizers |
