...
| **Quantified**        | **5** workflows (W1–W5) | **8** attack categories · **124** payloads · **25** CVEs reproduced (DCMTK, GDCM, Orthanc, pydicom, dcm4che) (+ inspired-by & config-file CVEs) | **6** targets · **2** engines · **3** sanitizers |
